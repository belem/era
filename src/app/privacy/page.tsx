    ...
    <main className="px-6 py-16 md:px-12 lg:px-[20%] xl:px-[28%]">
      ...
      <div className="space-y-6 text-[15px] leading-[1.8] text-text-secondary">
        ...
        <section>
          ...
          <p>
            跬步仅收集提供服务所必需的最少数据：您的登录凭据（邮箱地址）、用户名、年级以及学习进度数据（复习记录、连续天数）。我们不收集设备指纹、位置信息或任何与学习无关的个人数据。
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            所有数据采用行级安全策略确保用户仅能访问自己的数据。数据库位于受保护的云基础设施中，传输过程全程使用 TLS 加密。
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            跬步不使用任何云端 AI 服务。语音朗读功能完全在您的设备本地运行（WebGPU，WebNN 或浏览器内置语音合成），您的诗词内容不会发送到任何第三方服务器。
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            跬步面向家长监护人使用。学生昵称及年级由监护人创建和管理，学生本人无需提供任何个人联系信息。我们不会主动联系学生用户，也不会向未成年人展示任何广告或营销内容。
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            您可以随时删除学生昵称及年级信息，相关的所有学习数据将被永久删除。如需删除账户，请联系我们，我们将在 7 个工作日内完成处理。
          </p>
        </section>
